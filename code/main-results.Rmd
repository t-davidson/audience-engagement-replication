...
pdf("../figures/combined_sims_final.pdf")
par(mfrow=c(3,3))
dynardl.simulation.plot(resids.posts.sim.likes, type="area", response="levels", ylab="Activity", main='Likes', xlab="", ylim = c(ymin.p, ymax.p), bw = T)
dynardl.simulation.plot(resids.posts.sim.comments, type="area", response="levels", ylab="", main='Comments', xlab="", ylim = c(ymin.p, ymax.p), bw = T)
dynardl.simulation.plot(resids.posts.sim.shares, type="area", response="levels", ylab="", main="Shares", xlab="", ylim = c(ymin.p, ymax.p), bw = T)
dynardl.simulation.plot(recruits.sim.posts, type="area", response="levels", ylab="Recruitment", main='Posts', xlab="", ylim = c(ymin.r, ymax.r), bw = T)
dynardl.simulation.plot(recruits.sim.comments, type="area", response="levels", ylab="", main='Comments', xlab="", ylim = c(ymin.r, ymax.r), bw = T)
dynardl.simulation.plot(recruits.sim.shares, type="area", response="levels", ylab="", main="Shares", xlab="", ylim = c(ymin.r, ymax.r), bw = T)
dynardl.simulation.plot(supporters.sim.posts, type="area", response="levels", ylab="Support", main='Posts', xlab="", ylim = c(ymin.s, ymax.s), bw = T)
dynardl.simulation.plot(supporters.sim.comments, type="area", response="levels", ylab="", main='Comments', xlab="Time", ylim = c(ymin.s, ymax.s), bw = T)
dynardl.simulation.plot(supporters.sim.shares, type="area", response="levels", ylab="", main="Shares", xlab="", ylim = c(ymin.s, ymax.s), bw = T)
dev.off()
```
